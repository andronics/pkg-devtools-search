# search - AI Assistant Instructions

**Package**: `@devtools/search`
**Version**: 0.1.0
**Type**: devtools package

## Package Overview

**Description**: Search Tools - File and content search utilities

**Purpose**: Provide search tools - file and content search utilities functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/search` - Main executable
...
1. **Test installation**: `stow search`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D search`
